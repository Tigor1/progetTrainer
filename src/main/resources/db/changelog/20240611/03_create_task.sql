...
COMMENT ON COLUMN task.title IS 'заголовок задачи';
COMMENT ON COLUMN task.difficulty IS 'сложность задачи';
...
CREATE INDEX IF NOT EXISTS task_tittle_idx ON task (title);